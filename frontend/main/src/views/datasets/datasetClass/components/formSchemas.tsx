...
export const toolTypeList3D = [
  ...
  {
    id: 2,
    img: polyline, // 使用polyline图标作为3D折线的临时图标
    type: ToolTypeEnum.POLYLINE_3D,
    text: t('business.class.toolType.polyline3D'),
  },
  {
    id: 3,
    img: ploygon, // 使用polygon图标作为3D多边形的临时图标
    type: ToolTypeEnum.POLYGON_3D,
    text: t('business.class.toolType.polygon3D'),
  },
  {
    id: 4,
    img: ploygon, // 使用polygon图标作为3D分割的临时图标
    type: ToolTypeEnum.SEGMENTATION_3D,
    text: t('business.class.toolType.segmentation3D'),
  },
];
