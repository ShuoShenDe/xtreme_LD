...
export const createForm: FormSchema[] = [
  ...
  },
  {
    ...
    componentProps: {
      options: [
        { label: t('business.models.modelTypes.detection'), value: 'DETECTION' },
        { label: t('business.models.modelTypes.tracking'), value: 'TRACKING' },
        { label: t('business.models.modelTypes.interactive'), value: 'INTERACTIVE' }
      ],
    },
