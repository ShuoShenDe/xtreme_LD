...
import UpdatePointsTransform, { IUpdatePointsTransformOption } from './UpdatePointsTransform';
export interface ICmdOption {
    ...
    'update-points-transform': IUpdatePointsTransformOption;
}
...
const CMD: Record<Name, any> = {
    ...
    'add-track': AddTrack,
    'update-points-transform': UpdatePointsTransform,
};
