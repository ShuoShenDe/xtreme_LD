...
export default class ViewManager {
    ...
    updateViewAction(view: RenderView) {
        ...
        if (view instanceof SideRenderView) {
            ...
            // Configure point edit action
            let pointEditAction = view.getAction('point-edit') as PointEditAction;
            if (pointEditAction) {
                pointEditAction.toggle(config.op === OPType.EXECUTE);
            }
        ...
        if (view instanceof MainRenderView) {
            // Configure point edit action for main view
            let pointEditAction = view.getAction('point-edit') as PointEditAction;
            if (pointEditAction) {
                pointEditAction.toggle(config.op === OPType.EXECUTE);
            }
