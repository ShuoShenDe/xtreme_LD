const en = {
    ...
    title_createPolyline3D: 'Create Polyline(3D)',
    title_createPolygon3D: 'Create Polygon(3D)',
    title_createSegmentation3D: 'Create Segmentation(3D)',
    title_translate: 'Translate',
    title_pointEdit: 'Point Edit',
