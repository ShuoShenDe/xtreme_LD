...
import { useTaskComment } from '@/ltmComponents/qualityPanel/useTaskComment';
import { useCommentStore } from '@/stores/comment';
import useObjectCommentManager from '@/ltmComponents/qualityPanel/useObjectComment';

const { t } = useI18n();
const { taskComments, handleReply: replyComment, handleDelete: deleteComment, handleChangeStatus: changeStatus } = useTaskComment();
