...
export enum ToolName {
  ...
  'comment-bubble' = 'comment-bubble', // comment bubble tool, ToolType.COMMENT_BUBBLE
  iss = 'iss', // iss tool, ToolType.ISS - Instance Semantic Segmentation
  'iss-rect' = 'iss-rect', // iss rect tool, ToolType.ISS + AI
  'iss-points' = 'iss-points', // iss points tool, ToolType.ISS + AI
  // model
  model = 'model',
  // interactive
...
export enum ModelCodeEnum {
  ...
  IMAGE_INTERACTIVE = 'IMAGE_INTERACTIVE',
