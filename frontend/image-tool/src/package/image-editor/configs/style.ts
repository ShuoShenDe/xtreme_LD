...
export const defaultCommentBubbleConfig: IShapeConfig = {
  fill: 'rgba(255, 107, 107, 0.5)',
  stroke: '#ffffff',
  strokeWidth: 2,
  hitStrokeWidth: 6,
};
export const hoverCommentBubbleConfig: IShapeConfig = {
  fill: 'rgba(255, 138, 138, 0.5)',
  stroke: '#ffffff',
  strokeWidth: 3,
};
export const selectCommentBubbleConfig: IShapeConfig = {
  fill: 'rgba(255, 82, 82, 0.5)',
  stroke: '#ffffff',
  strokeWidth: 3,
};
export const CommentBubbleStateStyle: Record<StateType, IShapeConfig> = {
  general: defaultCommentBubbleConfig,
  hover: hoverCommentBubbleConfig,
  select: selectCommentBubbleConfig,
};
