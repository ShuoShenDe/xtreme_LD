<template>
  <div class="tool-header">
    ...
    <div class="header-right">
      <!-- Language Switch -->
      <Tooltip :title="editor.lang('language')">
...
<script setup lang="ts">
  ...
  import { Event as EditorEvent, LangType } from 'image-editor';
  ...
  const currentLanguage = ref<LangType>(LangType['en-US']);
  ...
  onMounted(() => {
    // Read language from localStorage and set editor language
    const savedLang = localStorage.getItem('lang') || LangType['en-US'];
    currentLanguage.value = savedLang as LangType;
    editor.state.lang = savedLang as LangType;
  });
