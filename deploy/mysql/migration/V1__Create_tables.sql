...
(
    ...
    `model_type`     enum ('DETECTION','TRACKING','INTERACTIVE')                      DEFAULT 'DETECTION' COMMENT 'Model type',
    `model_code`     enum ('PRE_LABEL','COCO_80','LIDAR_DETECTION','IMAGE_DETECTION','IMAGE_INTERACTIVE') DEFAULT NULL COMMENT 'Model''s unique identifier',
